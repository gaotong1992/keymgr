...
<section id="login">
    <header style="text-align: center;border-radius:10px;background-color: transparent;">
        <h3>中医药文献数据结构化处理系统  -  云平台</h3>
    </header>
    ...
    <!-- Login -->
    <form class="box tile animated active" id="box-login" action="<%=basePath%>login" method="post" style="margin-top: 150px;float: left;width: 400px;margin-left: 800px;">
        ...
        <button class="btn btn-sm m-r-5"  onclick="uLogin()">登录</button>
